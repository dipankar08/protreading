...
from myapp.core.KeyValueStore import KeyValueStore
from typing import Dict, List
from myapp.core.IndicatorBuilder import IndicatorBuilder
...
class FastStorage:
    ...
    def refreshData(self, candle_type: TCandleType):
        ...
        task = celery_download_process_save.apply_async()
...
@app.celery.task(name="backend.app.download_process_save")
def celery_download_process_save():
