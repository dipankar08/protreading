...
gunicorn --certfile=/etc/letsencrypt/live/rc1.grodok.com/fullchain.pem  --keyfile=/etc/letsencrypt/live/rc1.grodok.com/privkey.pem -w 4 --timeout 500 --bind 0.0.0.0:5000 app
