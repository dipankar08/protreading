        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = context.browser;
                    switch (_a) {
                        case EBrowserType.Chrome: return [3 /*break*/, 1];
                        case EBrowserType.Firefox: return [3 /*break*/, 3];
                    }
                    return [3 /*break*/, 5];
                case 1: return [4 /*yield*/, getChromeDriver(context)];
                case 2: return [2 /*return*/, _b.sent()];
                case 3: return [4 /*yield*/, getFireFoxDriver(context)];
                case 4: return [2 /*return*/, _b.sent()];
                case 5: throw new Error("Not support type " + context + ".");
            }
        });
    });
}
